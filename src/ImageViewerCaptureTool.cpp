...
void ImageViewerCaptureTool::setupViewer(osg::ref_ptr<osg::Group> node, uint width, uint height, double fovY)
{
    ...
    osg::ref_ptr<osg::Texture2D> pass12tex = createFloatTexture(width, height);
    ...
    osg::ref_ptr<osg::Camera> pass2cam = createRTTCamera(osg::Camera::COLOR_BUFFER, pass2tex, gfxc);
