...
BOOST_AUTO_TEST_CASE(multipass_testCase) {
    ...
    osg::ref_ptr<osg::StateSet> pass1state = pass1cam->getOrCreateStateSet();
    pass1state->setAttributeAndModes( pass1prog.get() );
    ...
    pass2cam->getOrCreateStateSet()->setTextureAttributeAndModes( 0, pass12tex, osg::StateAttribute::ON | osg::StateAttribute::OVERRIDE );
    pass2cam->getOrCreateStateSet()->setAttributeAndModes( pass2prog.get() );
